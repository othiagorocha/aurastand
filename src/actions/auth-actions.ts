...
export async function registerUser(prevState: AuthFormState | undefined, formData: FormData): Promise<AuthFormState> {
  try {
...
export async function loginUser(prevState: AuthFormState | undefined, formData: FormData): Promise<AuthFormState> {
  try {
